...
public class ListParkingPresenterImpl implements ListParkingPresenter {
    ...
    public ListParkingPresenterImpl(ListParkingView view, Context context) {
        this.view = view;
